    ...
    def __init__(self, data_path, embed_path, max_adu=128):
        ...
        with open(data_path) as f:
            for line in f:
                ...
                for key in ['shell_span', 'span', 'ac_position_info', 'adu_label', 'rel_label', 'author']:
                    if(key in temp):
                        try:
...
if(__name__ == '__main__'):
    data_path = './../../preprocess/dataset/CMV_gaku_test'
    embed_path = './../../preprocess/dataset/CMV_elmo.hdf5'
    ...
    print('----------')
    batch_size = 4
    train_dataloader = DataLoader(dataloader, batch_size=batch_size,shuffle=False, num_workers=0,collate_fn=tree_collate_fn)
